...
<html lang="sr">
   ...
   <body class="nomobile" style= "font-family:Dosis, Georgia, Serif;">
      ...
      <div class="container" style="display: table; margin: 0 auto;">
         <h1 style="margin-top:100px; text-align:center; padding:20px;">Godišnji izveštaj za pružaoce usluga fiksne javne telefonske mreže</h1>
         <button style="margin-top:100px;display: table; margin: 0 auto;" onclick="pokreni()" class="btn btn-warning">Pokreni izradu izvestaja</button>
         <table class="table">
            <thead>
               <tr>
                  <th>ID</th>
